...
int main() {
    ...
    cout<<"Input: "<<input1<< " → " <<(s.isBalanced(input1) ? "Balanced":"Unbalanced")<<endl;
    cout<<"Input: " <<input2<< " → " <<(s.isBalanced(input2) ? "Balanced":"Unbalanced")<<endl;

    string userInput;
    cout<<"Enter a string of brackets: ";
    cin>>userInput;
    cout<<(s.isBalanced(userInput)?"Balanced":"Unbalanced")<<endl;
